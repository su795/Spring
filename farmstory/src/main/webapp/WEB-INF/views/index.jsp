...
<main>
    <div class="slider">
        ...
        <img src="/farmstory/img/main_slide_img_tit.png" alt="사람과 자연을 사랑하는 팜스토리"/>
        
        <ul>
            <li><img src="/farmstory/img/main_slide_img1.jpg" alt="slide1"></li>
            <li><img src="/farmstory/img/main_slide_img2.jpg" alt="slide2"></li>
            <li><img src="/farmstory/img/main_slide_img3.jpg" alt="slide3"></li>
        </ul>

        <div class="banner">
            <img src="/farmstory/img/main_banner_txt.png" alt="GRAND OPEN"/>
            <img src="/farmstory/img/main_banner_tit.png" alt="30% 할인 이벤트"/>
            <img src="/farmstory/img/main_banner_img.png" alt="과일"/>
        </div>
    </div>
    <div class="quick">
        <a href="#"><img src="/farmstory/img/main_banner_sub1_tit.png" alt="오늘의 식단"/></a>
        <a href="#"><img src="/farmstory/img/main_banner_sub2_tit.png" alt="나도 요리사"/></a>
    </div>
    ...
    <div class="latest">
        <div>
            ...
            <table border="0">
            	<%-- 
	            	<c:forEach var="board" items="${latest1}">
		            	<tr>
		                    <td>></td>
		                    <td>${board.title}</td>
        ...
        <div>
            ...
            <table border="0">
                <c:forEach var="board" items="${latest2}">
		            	<tr>
		                    <td>></td>
		                    <td>${board.title}</td>
		                    <td>${board.rdate.substring(2, 10)}</td>
        ...
        <div>
            ...
            <table border="0">
                <c:forEach var="board" items="${latest3}">
	            	<tr>
	                    <td>></td>
	                    <td>${board.title}</td>
	                    <td>${board.rdate.substring(2, 10)}</td>
    ...
    <div class="info">
        <div class="cs">
            ...
            <div>
                <a href="#"><img src="/farmstory/img/main_sub2_cs_bt1.png" alt="고객문의"/></a>
                <a href="#"><img src="/farmstory/img/main_sub2_cs_bt2.png" alt="자주묻는 질문"/></a>
