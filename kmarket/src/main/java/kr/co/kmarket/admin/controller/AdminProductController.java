...
import kr.co.kmarket.persistence.AdminCategory1Repo;
import kr.co.kmarket.persistence.AdminCategory2Repo;
...
public class AdminProductController {
	...
	public int delete(String[] codes) {
		...
		// mapper에서 `code`=#{code}문으로 작성했다면 controller에서 for문으로 변수를 배열로 지정해줘야됨
		// for(code:codes) {
